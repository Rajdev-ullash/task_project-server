...
client.connect(err => {
    const ProductCollection = client.db("contactless-project").collection("contactless");
    const OrderCollection = client.db("contactless-project").collection("order");
    const AdminCollection = client.db("contactless-project").collection("admin");
    ...
    app.post('/addProduct', (req, res) => {
        ...
        ProductCollection.insertOne(newService)
            .then(result => {
